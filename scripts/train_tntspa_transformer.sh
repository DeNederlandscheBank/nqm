...
ID=14126 # find in build script or end of fairseq-data-bin
IN_DIR=data/eiopa/5_model_input
MODEL_DIR=models/transformer_tntspa

fairseq-train $IN_DIR/fairseq-data-bin-$ID \
 -a transformer_iwslt_de_en \
 --restore-file $MODEL_DIR/transformer_tntspa.pt \
 --reset-dataloader --reset-lr-scheduler --reset-meters --reset-optimizer \
 --optimizer adam --lr 0.0005 -s nl -t ql \
